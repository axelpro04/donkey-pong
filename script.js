$( document ).ready(function(){
    ...
    var audio = new Audio("donkey.mp3"); 
    console.log(audio); 
    audio.play();
    ...
    function gameStart() {
        ...
        var line = {
            CSS: {
                width: 0,
                height: 0,
                borderLeft: '2px dashed rgba(0, 0, 0, 0%)',
                position: 'absolute',
                top: 0,
                left: '50%'
            }
        ...
        var draw = {
            ...
            // Creation des elements dans le fichier htlm
            drawMenuItems: function () {
                this.drawItemTo('div', 'game-menu', arena.CSS, 'body');
                this.drawItemTo('div', 'pong-game-text', winnerText.CSS, '#game-menu', '');
                this.drawItemTo('button', 'btn-player-player', menuButton.CSS, '#game-menu', 'JOUEUR V JOUEUR');
                menuButton.CSS.top = (parseInt(menuButton.CSS.top) + 50) + 'px';
    
                this.drawItemTo('button', 'btn-player-cpu', menuButton.CSS, '#game-menu', 'JOUEUR VS ORDI');
                menuButton.CSS.top = (parseInt(menuButton.CSS.top) + 50) + 'px';
    
                this.drawItemTo('button', 'btn-cpu-cpu', menuButton.CSS, '#game-menu', 'ORDI VS ORDI');
            },
